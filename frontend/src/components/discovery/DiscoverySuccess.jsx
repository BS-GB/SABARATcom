    ...
    const handleDownloadPDF =
        async () => {
            ...
            try {
                ...
                alert(
                    "حدث خطأ أثناء إنشاء ملف PDF. تأكد من اتصال المتصفح بالصفحة ثم حاول مرة أخرى."
                );
            ...
            >
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="mt-1 text-slate-500">
                                نحن متحمسون جداً لبدء هذه الرحلة معك، .
                            </p>

                            <p className="mt-3 font-bold text-slate-700">
                                خطوتك القادمة لبدء النجاح:
                            </p>

                            <p className="mt-1 text-slate-500">
                                .يمكنك الآن استكشاف ماتريد والمميزات المتاحة لك
                            </p>
                ...
                >
                    ...
                    <InfoGrid>
                        ...
                        <InfoItem
                            label="القنوات التسويقية المفضلة"
                            value={
                                (
                                    formData
                                        .additional
            ...
            <style>
                {`
                    @media print {
                        ...
                        #discovery-print-area h2,
                        #discovery-print-area h3 {
                            break-after: avoid;
