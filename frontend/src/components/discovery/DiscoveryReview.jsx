        ...
        <div className="mx-auto max-w-4xl py-8">
            ...
            <div className="mt-10 space-y-5">
                ...
                <ReviewCard
                    ...
                    items={[
                        [
                            "سبق التعاون مع وكالة",
                            formData?.previousCollaboration?.workedBefore,
                        ],
                        [
                            "اسم الوكالة",
                            formData?.previousCollaboration?.agencyName,
                        ],
                        [
                            "سبب انتهاء التعاون",
                            formData?.previousCollaboration?.reason,
                        ],
                        [
                            "النتيجة",
                            formData?.previousCollaboration?.result,
                        ],
                        [
                            "ما المطلوب تحسينه",
                            formData?.previousCollaboration?.improvement,
                        ],
                    ]}
                />
                ...
                <ReviewCard
                    ...
                    items={[
                        [
                            "القنوات المفضلة",
                            Array.isArray(
                                formData?.additional?.preferredChannels
                            )
                        ...
                        [
                            ...
                            formData?.additional?.preferredContact,
                        ],
                        [
                            "موعد بدء المشروع",
                            formData?.additional?.startDate,
                        ],
                        [
                            "مصدر التعرف على SABARAT",
                            formData?.additional?.source,
                        ],
                        [
                            "ملاحظات",
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <span className="font-bold text-[#5EA8CC]">
                            {" "}SABARAT
                        </span>
                        .
                    </span>
            ...
            <div className="mt-3 min-h-[28px]">
                ...
                {privacyAccepted ? (
                    ...
                    <p
                        ...
                        "
                    >
                        يجب تأكيد الموافقة على استخدام البيانات
                        قبل إرسال الطلب.
                    </p>
